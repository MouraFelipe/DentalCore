    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Spacer(),
          Center(child: SizedBox(width: 120, height: 120, child: _DonutChart(value: ocupacao))),
          const Spacer(),
...
class _DonutPainter extends CustomPainter {
  ...
  @override bool shouldRepaint(_DonutPainter o) => o.value != value;
}
