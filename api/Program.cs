...
var key = Encoding.ASCII.GetBytes(builder.Configuration["Jwt:Secret"] ?? "chave-ultra-secreta-e-longa-para-o-dentalcore-bi");
...
{
    c.SwaggerDoc("v1", new() { Title = "DentalCore API", Version = "v1" });
